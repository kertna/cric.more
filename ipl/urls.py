...
urlpatterns = [
    ...
    path('predictOverall/',views.predictOverall, name='predictOverall'),
    path('predictGround/',views.predictGround, name='predictGround'),
    path('predictAgainst/',views.predictAgainst, name='predictAgainst'),
    path('predictForm/',views.predictForm, name='predictForm'),
    path('predictSuggested/',views.predictSuggested, name='predictSuggested'),
    path('predictedteam1/',views.predictedteam1, name='predictedteam1'),
    path('predictedteam2/',views.predictedteam2, name='predictedteam2'),
    path('predictedteam3/',views.predictedteam3, name='predictedteam3'),
    path('predictedteam4/',views.predictedteam4, name='predictedteam4'),
    path('predictedteam5/',views.predictedteam5, name='predictedteam5'),
   ...
   # path('pl/<str:id>', views.positionlist, name='pl'),
    ...
    path('filterteamruns/',views.mainteamlist, name='mainteamlist'),
    path('filterteamruns/<str:team>/',views.filterteamruns,name='filterteamruns'),
    path('filterateamruns/',views.againstteamlist, name='againstteamlist'),
    path('filterateamruns/<str:team>/',views.filterateamruns,name='filterateamruns'),
    path('filterteamwickets/',views.mainwteamlist, name='mainwteamlist'),
    path('filterteamwickets/<str:team>/',views.filterteamwickets,name='filterteamwickets'),
    path('filterateamwickets/',views.mainawteamlist, name='mainawteamlist'),
    path('filterateamwickets/<str:team>/',views.filterateamwickets,name='filterateamwickets'),
    path('filtercityruns/',views.cityteamlist, name='cityteamlist'),
    path('filtercityruns/<str:city>/',views.filtercityruns,name='filtercityruns'),
    ...
    path('filtercitywickets/',views.citywteamlist, name='citywteamlist'),
    path('filtercitywickets/<str:city>/',views.filtercitywickets,name='filtercitywickets'),
